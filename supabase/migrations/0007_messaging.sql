...
-- ----------------------------------------------------------------- Realtime
-- Le proxy SSE serveur s'abonne aux changements de `messages` ; REPLICA
-- IDENTITY FULL pour que les événements UPDATE (soft-delete) portent le
-- match_id, qui sert au filtrage côté abonnement.
